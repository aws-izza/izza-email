                ...
                script {
                    withCredentials([usernamePassword(credentialsId: 'github-pat', 
                        ...
                        dir('izza-cd') {
                            ...
                            sh """
                                rm -rf environments/mock/eks-deployment.yaml
                                cp ../k8s_deployment/eks-deployment.yaml environments/mock/eks-deployment.yaml
                                sed -i 's|image: .*|image: ${ECR_REGISTRY}/${ECR_REPOSITORY}:${IMAGE_TAG}|' environments/mock/eks-deployment.yaml
                            """
                            
                            sh """
                                git add environments/mock/eks-deployment.yaml
